...
function Dashboard() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-start justify-between gap-8 md:p-8 marker:pb-0 p-4 pt-8 pb-0">
      <div className="space-y-5">
        ...
        <div>
          ...
          <div className="flex flex-col items-center max-w-4xl w-full overflow-hidden rounded-md bg-white border border-e-gray-500/20">
