...
function CourseDetails() {
  ...
  return (
    ...
    <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
      <div className=" absolute top-0 left-0 w-full h-section-hight  bg-gradient-to-b from-cyan-100/70 "></div>

      {/* left column */}
      <div className="max-w-xl z-10 text-gray-500">
        <h1 className="md:text-details-heading-large font-semibold text-gray-800 ">
          {coursData.courseTitle}
        </h1>
        <div
          className="pt-4 md:text-base text-sm"
          dangerouslySetInnerHTML={{
            __html: coursData.courseDescription.slice(0, 200),
          }}
        />
        ...
        <div className="flex items-center space-x-2 pt-3 pb-1 text-sm">
          ...
          <div className="flex ">
            {[...Array(5)].map((_, i) => (
              <img
                ...
                key={i}
                src={
                  i < Math.floor(calculateRating(coursData))
                    ? assets.star
                    : assets.star_blank
                }
              />
          ...
          <p>
            {coursData.enrolledStudents.length}
        ...
        <div className="py-20 text-sm md:text-default">
          ...
          <div
            ...
            dangerouslySetInnerHTML={{ __html: coursData.courseDescription }}
          />
        </div>
      </div>
        ...
        <div className="p-5">
          ...
          <div className="flex gap-3 items-center pt-2">
            <p className=" text-gray-800 md:text-4xl text-2xl font-semibold">
              {currency}{" "}
              {(
                coursData.coursePrice -
                (coursData.discount * coursData.coursePrice) / 100
              ).toFixed(2)}
            </p>
          ...
          <div className="flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500">
            ...
            <div className="flex items-center gap-1">
              ...
              <p>{calculateCourseDuration(coursData)}</p>
            </div>
            ...
            <div className="flex items-center gap-1">
              ...
              <p>{calculateNoOfLectures(coursData)} lessons</p>
            </div>
          </div>
          ...
          <div className="pt-6">
            ...
            <ul className="ml-4 pt-2 text-sm md:text-default list-disc text-gray-500 ">
              ...
              <li>Downloadable resources and source guidance.</li>
